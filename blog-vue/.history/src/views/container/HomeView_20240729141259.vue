    ...
    <el-container class="container">
      ...
      <el-footer>
        ...
        <div style="color: #fd7286;font-size: large;font-weight: bolder;width: 55%;margin-left: 12%;">
          ...
          <a href="https://beian.miit.gov.cn" class="icp" target="_blank">赣ICP备2024025296号-1</a>
          <el-image :src="require('@/assets/record.png')" style="width: 17px;height: 17spx;"></el-image>
          <a href="https://beian.mps.gov.cn/#/query/webSearch?code=36098102000290" class="icp" rel="noreferrer" target="_blank">&ensp;赣公网安备36098102000290</a>
        </div>
