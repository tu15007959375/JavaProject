<template>
  <div>
    ...
    <el-descriptions title="用户信息" style="margin: auto;padding-left: 45px;padding-top: 45px;width: 890px;line-height: normal;" :column="4" >
      <el-descriptions-item label="发布时间">{{articleInfo.createTime}}</el-descriptions-item>
      ...
      <el-descriptions-item label="分类专栏">
        <el-tag size="small">{{articleInfo.categoryName}}</el-tag>
      </el-descriptions-item>
      <el-descriptions-item label="阅读量">xxx</el-descriptions-item>
      <el-descriptions-item label="总字数">xxx</el-descriptions-item>
