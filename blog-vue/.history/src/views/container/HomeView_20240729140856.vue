    ...
    <el-container class="container">
      ...
      <el-footer>
        ...
        <div style="color: #fd7286;font-size: large;font-weight: bolder;width: 55%;margin-left: 12%;">
          ...
          <el-image :src="require('@/assets/record.png')"></el-image>
          <a href="https://beian.mps.gov.cn/#/query/webSearch?code=36098102000290" rel="noreferrer" target="_blank">赣公网安备36098102000290</a>
        </div>
