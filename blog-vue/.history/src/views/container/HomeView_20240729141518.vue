    ...
    <el-container class="container">
      ...
      <el-footer>
        ...
        <div style="color: #fd7286;font-size: large;font-weight: bolder;width: 55%;margin-left: 12%;">
          ...
          <a href="https://beian.miit.gov.cn" class="icp" target="_blank">赣ICP备2024025296号-1&ensp;</a>
          <el-image :src="require('@/assets/record.png')" style="width: 17px;height: 17px;"></el-image>
