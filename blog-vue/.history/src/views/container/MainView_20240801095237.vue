<template>
    <div style="margin:0;border:0;padding:0;">
        ...
        <div>
            ...
            <div style="line-height: normal;margin-left: 12%;font-size: 15px;width: 55%;margin-top: 20px;">
                <el-card style="text-align: left;margin-bottom: 10px;color:#999;">
                    ...
                    &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                    <span class="iconspan" style="cursor: pointer;"
                        @click="changIconSelect(1)">文&nbsp;章&nbsp;简&nbsp;介</span><i class="el-icon-sort-down"></i><i
                        style="margin-left: -7px;" class="el-icon-sort-up"></i>
                    &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                    <span class="iconspan" style="cursor: pointer;color: black;"
                        @click="changIconSelect(2)">发&nbsp;布&nbsp;日&nbsp;期</span><i style="color: black"
                        class="el-icon-sort-down"></i><i style="margin-left: -7px;" class="el-icon-sort-up"></i>
                    &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                    <span class="iconspan" style="cursor: pointer;"
                        @click="changIconSelect(3)">更&nbsp;新&nbsp;日&nbsp;期</span><i class="el-icon-sort-down"></i><i
                        style="margin-left: -7px;" class="el-icon-sort-up"></i>
                    &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;

                    <span class="iconspan" style="cursor: pointer;" @click="changIconSelect(4)">访&nbsp;问&nbsp;量</span><i
                        class="el-icon-sort-down"></i><i style="margin-left: -7px;" class="el-icon-sort-up"></i>
                    &nbsp;|
                </el-card>
