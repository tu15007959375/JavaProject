<template>
    <div style="margin:0;border:0;padding:0;">
        ...
        <div>
            ...
            <div style="color:#999;line-height: normal;margin-left: 12%;font-size: 17px;width: 55%;color: #999;">
                    <el-card style="text-align: left;margin-bottom: 10px;">
                        |&nbsp;&nbsp;&nbsp;&nbsp;
                        <span>标&nbsp;题&nbsp;名&nbsp;称</span><i class="el-icon-sort-down"></i><i style="margin-left: -9px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
                        <span>文&nbsp;章&nbsp;简&nbsp;介</span><i class="el-icon-sort-down"></i><i style="margin-left: -9px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
                        <span>发&nbsp;布&nbsp;日&nbsp;期</span><i class="el-icon-sort-down"></i><i style="margin-left: -9px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
                        <span>更&nbsp;新&nbsp;日&nbsp;期</span><i class="el-icon-sort-down"></i><i style="margin-left: -9px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
            
                        <span>访&nbsp;问&nbsp;量</span><i class="el-icon-sort-down"></i><i style="margin-left: -9px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;&nbsp;|
                    </el-card>
