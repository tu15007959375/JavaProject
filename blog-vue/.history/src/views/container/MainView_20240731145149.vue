    ...
    methods: {
        ...
        selectTitle(){
            if(this.nowSelect != 0){
                ...
                this.icondown[0].style.color = 'black'
                
            }else{
                if(this.icondown[0].style.color == 'black'){
                    this.icondown[0].style.color = '#999'
                    this.iconup[0].style.color = 'black'
                }else{
                    this.icondown[0].style.color = 'black'
                    this.iconup[0].style.color = '#999'
                }
            }
            this.nowSelect = 0;
        },
