<template>
  <div>
    ...
    <el-descriptions title="用户信息" style="margin: auto;padding-left: 45px;padding-top: 45px;width: 890px;line-height: normal;" :column="4" >
      <el-descriptions-item label="发布时间">kooriookami</el-descriptions-item>
      <el-descriptions-item label="点赞数">苏州市</el-descriptions-item>
      <el-descriptions-item label="喜欢数">苏州市</el-descriptions-item>
      <el-descriptions-item label="微笑数">苏州市</el-descriptions-item>
      <el-descriptions-item label="阅读量">18100000000</el-descriptions-item>
      <el-descriptions-item label="总字数">18100000000</el-descriptions-item>
      <el-descriptions-item label="备注">
        <el-tag size="small">学校</el-tag>
      </el-descriptions-item>
      <el-descriptions-item label="分类专栏">江苏省苏州市吴中区吴中大道 1188 号</el-descriptions-item>
      <el-descriptions-item label="文章简介">苏州市</el-descriptions-item>
  </el-descriptions>
