<template>
  <div>
    ...
    <el-card style="width: 55%;margin: auto;">
      <el-descriptions title="" style="margin: auto;padding-left: 45px;padding-top: 45px;width: 890px;line-height: normal;" :column="4" >
        ...
        <el-descriptions-item label="阅读量">{{articleInfo.pageView}}</el-descriptions-item>
        ...
        fp.get().then(result => {
          ...
          axios({
            ...
            if (res.data.code == 1) {
              ...
              this.articleInfo.createTime = this.articleInfo.createTime.replace('T',' ')
            }
          })
        });
      });
