        ...
        <div>
            ...
            <div style="line-height: normal;margin-left: 12%;font-size: 17px;width: 55%;margin-top: 20px;">
                    <el-card style="text-align: left;margin-bottom: 10px;color:#999;">
                        |&nbsp;&nbsp;&nbsp;
                        <span style="cursor: pointer;">标&nbsp;题&nbsp;名&nbsp;称</span><i class="el-icon-bottom"></i><i style="margin-left: -9px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        <span style="cursor: pointer;">文&nbsp;章&nbsp;简&nbsp;介</span><i class="el-icon-bottom"></i><i style="margin-left: -9px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        <span style="cursor: pointer;">发&nbsp;布&nbsp;日&nbsp;期</span><i style="color: rgb(0,190,255)" class="el-icon-bottom"></i><i style="margin-left: -9px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        <span style="cursor: pointer;">更&nbsp;新&nbsp;日&nbsp;期</span><i class="el-icon-bottom"></i><i style="margin-left: -9px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
            
                        <span style="cursor: pointer;">访&nbsp;问&nbsp;量</span><i class="el-icon-bottom"></i><i style="margin-left: -9px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;|
                    </el-card>
