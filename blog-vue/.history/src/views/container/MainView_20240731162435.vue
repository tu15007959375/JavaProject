        ...
        <div>
            <div class="info">
                <el-card>
                    ...
                    :expand-on-click-node="true" :check-strictly="false"   :default-expand-all="true" node-key="id"
            ...
            <div style="line-height: normal;margin-left: 12%;font-size: 17px;width: 55%;margin-top: 20px;">
                    <el-card style="text-align: left;margin-bottom: 10px;color:#999;">
                        |&nbsp;
                        <span class="iconspan" style="cursor: pointer;" @click="changIconSelect(0)">标&nbsp;题&nbsp;名&nbsp;称</span><i class="el-icon-sort-down" ></i><i style="margin-left: -7px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        <span class="iconspan" style="cursor: pointer;" @click="changIconSelect(1)">文&nbsp;章&nbsp;简&nbsp;介</span><i class="el-icon-sort-down"></i><i style="margin-left: -7px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        <span class="iconspan" style="cursor: pointer;color: black;" @click="changIconSelect(2)">发&nbsp;布&nbsp;日&nbsp;期</span><i style="color: black" class="el-icon-sort-down"></i><i style="margin-left: -7px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        <span class="iconspan" style="cursor: pointer;" @click="changIconSelect(3)">更&nbsp;新&nbsp;日&nbsp;期</span><i class="el-icon-sort-down"></i><i style="margin-left: -7px;" class="el-icon-sort-up"></i>
                        &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
            
                        <span class="iconspan" style="cursor: pointer;" @click="changIconSelect(4)">访&nbsp;问&nbsp;量</span><i class="el-icon-sort-down"></i><i style="margin-left: -7px;" class="el-icon-sort-up"></i>
                        &nbsp;|
                    </el-card>
...
export default {
    ...
    methods: {
        ...
        changIconSelect(index){
            ...
            if(this.nowSelect != index){
                iconspan[this.nowSelect].style.color = '#999'
                this.icondown[this.nowSelect].style.color = '#999'
                this.iconup[this.nowSelect].style.color = '#999'
                this.icondown[index].style.color = 'black'
                this.order = 1
            }else{
                if(this.icondown[index].style.color == 'black'){
                    this.icondown[index].style.color = '#999'
                    this.iconup[index].style.color = 'black'
                    this.order = -1
                }else{
                    this.icondown[index].style.color = 'black'
                    this.iconup[index].style.color = '#999'
                    this.order = 1
                }
            }
